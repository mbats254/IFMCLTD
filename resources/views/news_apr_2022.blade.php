...
<!--home wehere it happens section-->   
 <section class="p-14">
      ...
      <section class="news-form">
            ...
            <section class="blog page4-active">
                <section class="page4">
                
                        @foreach($jesus as $jesu)
                  
                    <div class="blog-box">
                        <div class="blog-img">
                            <img src="{{$jesu->img}}" alt="">
                        </div>
                        <div class="blog-details">
                            <h4>{{$jesu->heading}}</h4>
                            <p>{{$jesu->phrase}}</p>
                            <a href="#" class="kiburn" onclick="{{$jesu->link}}">CONTINUE READING <i class="fas fa-long-arrow-right"></i></a>
                        </div>
                        <H1>{{$jesu->date}}</H1>
                    </div>
                    @endforeach
            ...
            <section class="page-numbers weeknd-active">
                <ul class="weeknd">
                    ...
                    <li class=""><a href="/news_apr_2022" class="pg4 pantha paranoid">Apr</a></li>
            ...
            <section class="cKaiga">
                <div class="main-kaiga">
                    ...
                    <div class="subject-kaiga">
                        <div class="hding"><h1>{{$jesu->date}}</h1></div>
                        <div class="kaiga-img" id="tengana">
                            <img src="{{$jesu->img}}" alt="">
                        </div>
                        <div class="kaiga-dtail">
                            <h4>{{$jesu->heading}}</h4>
                            <p>{{$jesu->phrase_full}}</p>
                        </div>
                    </div>
                    @endforeach
