...
<!--home wehere it happens section-->   
 <section class="p-14">
  ...
  @foreach($servicei_1s as $servicei_1)
       <section class="intro-Outsourcing">
              <p>{{$servicei_1->tittle}}<span>{{$servicei_1->tittle_2}}</span></p>
                <a href="{{$servicei_1->back_link}}" class="bckbtn4" style="text-decoration: none;"><span class="dr2"><i class="fas fa-door-open"></i></span><span
                        class="dr1"><i class="fas fa-door-closed"></i></span> {{$servicei_1->back_text}}</a>
            </section>
            <section class="Outsourcing-detail-body">
                <div class="first-Outsourcing">
                    <div class="fo-left">
                        <h2>{{$servicei_1->heading}}</h2>
                        <p>{{$servicei_1->phrase}}</p>
                    </div>
                    <div class="fo-center">
                    @foreach($servicei_2s as $servicei_2)
                        <li>
                            <i class="fas fa-long-arrow-right"></i>
                            <div>
                                <h1>{{$servicei_2->heading}}</h1>
                                <p>{{$servicei_2->phrase}}</p>
                            </div>
                        </li>
                    @endforeach
                    </div>
                    <div class="fo-right">
                    @foreach($servicei_3s as $servicei_3)
                        <li>
                            <i class="fas fa-long-arrow-right"></i>
                            <div>
                                <h1>{{$servicei_3->heading}}</h1>
                                <p>{{$servicei_3->phrase}}</p>
                            </div>
                        </li>
                    @endforeach
                    </div>
