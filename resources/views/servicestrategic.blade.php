...
<!--home wehere it happens section-->   
 <section class="p-14">
  ...
  @foreach($servicest_1s as $servicest_1)
       <section class="intro-Cloud">
            <p>{{$servicest_1->tittle}}<span>{{$servicest_1->tittle_2}}</span></p>
                <a href="{{$servicest_1->back_link}}" class="bckbtn3" style="text-decoration: none;"><span class="dr2"><i class="fas fa-door-open"></i></span><span
                        class="dr1"><i class="fas fa-door-closed"></i></span> {{$servicest_1->back_text}}</a>
            </section>
            <section class="Cloud-detail-body">
                <div class="first-Cloud">
                    <div class="fc-left">
                        <h2>{{$servicest_1->heading}}</h2>
                        <p>{{$servicest_1->phrase}} </p>
                            <h1>{{$servicest_1->small_head}}</h1>
                            @foreach($servicest_2s as $servicest_2)
                            <li>{{$servicest_2->phrase}}</li>
                            @endforeach
                            
                    </div>
                    <div class="fc-right">
                        <img src="{{$servicest_1->img}}" alt="" height="500" width="100%">
                    </div>
                </div>
