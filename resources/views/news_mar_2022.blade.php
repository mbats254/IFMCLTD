...
<!--home wehere it happens section-->   
 <section class="p-14">
      ...
      <section class="news-form">
            ...
            <section class="blog page3-active">
                <section class="page3">
                
                        @foreach($situwashons as $situwashon)
                  
                    <div class="blog-box">
                        <div class="blog-img">
                            <img src="{{$situwashon->img}}" alt="">
                        </div>
                        <div class="blog-details">
                            <h4>{{$situwashon->heading}}</h4>
                            <p>{{$situwashon->phrase}}</p>
                            <a href="#" class="kiburn" onclick="{{$situwashon->link}}">CONTINUE READING <i class="fas fa-long-arrow-right"></i></a>
                        </div>
                        <H1>{{$situwashon->date}}</H1>
                    </div>
                    @endforeach
                </section>
            </section>
            <section class="page-numbers weeknd-active">
                <ul class="weeknd">
                    <li class=""><a href="/news" class="pg1 pantha">Jan</a></li>
                    <li class=""><a href="/news_feb_2022" class="pg2 pantha">Feb</a></li>
                    <li class=""><a href="/news_mar_2022" class="pg3 pantha paranoid">Mar</a></li>
            ...
            <section class="cKaiga">
                <div class="main-kaiga">
                    ...
                    <div class="subject-kaiga">
                        <div class="hding"><h1>{{$situwashon->date}}</h1></div>
                        <div class="kaiga-img" id="tengana">
                            <img src="{{$situwashon->img}}" alt="">
                        </div>
                        <div class="kaiga-dtail">
                            <h4>{{$situwashon->heading}}</h4>
                            <p>{{$situwashon->phrase_full}}</p>
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="related-kaiga">
                        ...
                        <div class="item1-kaiga">
                                <div class="item1-kaiga-img">
                                    <img src="/img/newsimg/b11.gif" alt="">
                                </div>
                            ...
                            <div class="item2-kaiga">
                                <div class="item2-kaiga-img">
                                    <img src="/img/newsimg/b13.gif" alt="">
                                </div>
                        ...
                        <div class="related-kaiga-body">
                            <div class="item1-kaiga">
                                <div class="item1-kaiga-img">
                                    <img src="/img/newsimg/eddy.jpg" alt="">
                                </div>
                                <div class="item1-kaiga-dtail">
                                    <h4>25 Years of Greatness</h4>
                                    <p>12th March 2022</p>
                            ...
                            <div class="item2-kaiga">
                                <div class="item2-kaiga-img">
                                    <img src="/img/newsimg/stadium.jpg" alt="">
                                </div>
                                <div class="item2-kaiga-dtail">
                                    <h4>25 Years of Greatness</h4>
                        ...
                        <div class="related-kaiga-body">
                            <div class="item1-kaiga">
                                <div class="item1-kaiga-img">
                                    <img src="/img/newsimg/fans.jpg" alt="">
                                </div>
                                <div class="item1-kaiga-dtail">
                                    <h4>25 Years of Greatness</h4>
                            ...
                            <div class="item2-kaiga">
                                <div class="item2-kaiga-img">
                                    <img src="/img/newsimg/pep.jpg" alt="">
                                </div>
                                <div class="item2-kaiga-dtail">
                                    <h4>25 Years of Greatness</h4>
                                    <p>5th July 2022</p>
                        ...
                        <div class="related-kaiga-body">
                            <div class="item1-kaiga">
                                <div class="item1-kaiga-img">
                                    <img src="/img/newsimg/b20.jpg" alt="">
                                </div>
                                <div class="item1-kaiga-dtail">
                                    <h4>25 Years of Greatness</h4>
                                    <p>21st July 2022</p>
                            ...
                            <div class="item2-kaiga">
                                <div class="item2-kaiga-img">
                                    <img src="/img/newsimg/aguero.jpg" alt="">
                                </div>
                                <div class="item2-kaiga-dtail">
                                    <h4>25 Years of Greatness</h4>
                        ...
                        <div class="related-kaiga-body">
                            <div class="item1-kaiga">
                                <div class="item1-kaiga-img">
                                    <img src="/img/newsimg/military.jpg" alt="">
                                </div>
                                <div class="item1-kaiga-dtail">
                                    <h4>25 Years of Greatness</h4>
                                    <p>5th June 2022</p>
                            ...
                            <div class="item2-kaiga">
                                <div class="item2-kaiga-img">
                                    <img src="/img/newsimg/gb.jpg" alt="">
                                </div>
                                <div class="item2-kaiga-dtail">
                                    <h4>25 Years of Greatness</h4>
                                    <p>5th March 2022</p>
