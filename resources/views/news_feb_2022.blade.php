...
<!--home wehere it happens section-->   
 <section class="p-14">
      ...
      <section class="news-form">
            ...
            <section class="blog page2-active">
                <section class="page2">
                
                        @foreach($vipengeles as $vipengele)
                  
                    <div class="blog-box">
                        <div class="blog-img">
                            <img src="{{$vipengele->img}}" alt="">
                        </div>
                        <div class="blog-details">
                            <h4>{{$vipengele->heading}}</h4>
                            <p>{{$vipengele->phrase}}</p>
                            <a href="#" class="kiburn" onclick="{{$vipengele->link}}">CONTINUE READING <i class="fas fa-long-arrow-right"></i></a>
                        </div>
                        <H1>{{$vipengele->date}}</H1>
                    </div>
                    @endforeach
                </section>
            </section>
            <section class="page-numbers weeknd-active">
                <ul class="weeknd">
                    ...
                    <li class=""><a href="/news_feb_2022" class="pg2 pantha paranoid">Feb</a></li>
            ...
            <section class="cKaiga">
                <div class="main-kaiga">
                    ...
                    <div class="subject-kaiga">
                        <div class="hding"><h1>{{$vipengele->date}}</h1></div>
                        <div class="kaiga-img" id="tengana">
                            <img src="{{$vipengele->img}}" alt="">
                        </div>
                        <div class="kaiga-dtail">
                            <h4>{{$vipengele->heading}}</h4>
                            <p>{{$vipengele->phrase_full}}</p>
                        </div>
                    </div>
                    @endforeach
