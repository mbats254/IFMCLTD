...
<!--home wehere it happens section-->   
 <section class="p-14">
  ...
  @foreach($serviceop_1s as $serviceop_1)
            <section class="intro-Taxation">
            <p>{{$serviceop_1->tittle}}<span>{{$serviceop_1->tittle_2}}</span></p>
                <a href="{{$serviceop_1->back_link}}" class="bckbtn2" style="text-decoration: none;"><span class="dr2"><i class="fas fa-door-open"></i></span><span
                        class="dr1"><i class="fas fa-door-closed"></i></span> {{$serviceop_1->back_text}}</a>
            </section>
            <section class="Taxation-detail-body">
                <div class="first-Taxation">
                    <div class="ft-left">
                        <h2>{{$serviceop_1->heading}}</h2>
                        <p>{{$serviceop_1->phrase}}</p>
                        <h1>{{$serviceop_1->small_head}}</h1>
                          @foreach($serviceop_2s as $serviceop_2)
                            <li>{{$serviceop_2->phrase}}</li>
                            @endforeach
                        </p>
                    </div>
                    <div class="ft-right">
                        <img src="{{$serviceop_1->img}}" alt="" height="500" width="100%">
                    </div>
                </div>
