        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('user.update', $user) }}" enctype="multipart" autocomplete="off">
                            @csrf
                            @method('put')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('avatar') ? ' has-danger' : '' }} col-md-6">
                                    <label class="form-control-label" for="avatar">{{ __('Avatar') }}</label>

                                    <input type="file" name="avatar" id="avatar" class="form-control form-control-alternative{{ $errors->has('avatar') ? ' is-invalid' : '' }}" placeholder="{{ __('Avatar') }}" value="{{ old('avatar') }}" required autofocus>
