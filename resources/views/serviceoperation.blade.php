...
<!--home wehere it happens section-->   
 <section class="p-14">
  ...
  <section class="service-form">
            ...
            <p>/Our/Services -<span>/ Operation & Logistic Management</span></p>
                <a href="/our/services" class="bckbtn2" style="text-decoration: none;"><span class="dr2"><i class="fas fa-door-open"></i></span><span
                        class="dr1"><i class="fas fa-door-closed"></i></span> Back to Service</a>
            </section>
            <section class="Taxation-detail-body">
                <div class="first-Taxation">
                    <div class="ft-left">
                        <h2>Operation & Logistic Management</h2>
                        <p>On Operation Management, We handle all processes related with production of items from raw materials to finished goods. On Logistic Management, We manage and monitor complex supply chain operations about how the resources are acquired, stored, and transported to the desired destination.
                        <h1>We help you with:</h1>
                      
                            <li>Product Design (Product compliant with customer needs and marketing trends).</li>
                    ...
                    <div class="ft-right">
                        <img src="/img/serviceimg/taxation.jpeg" alt="" height="500" width="100%">
                    </div>
                </div>
