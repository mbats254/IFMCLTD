 ...
 <section class="p-14">
  ...
  <section class="service-form">
       ...
       <section class="intro-Cloud">
            <p>/Our/Services -<span>/ Strategic Management</span></p>
                <a href="/our/services" class="bckbtn3" style="text-decoration: none;"><span class="dr2"><i class="fas fa-door-open"></i></span><span
            ...
            <section class="Cloud-detail-body">
                <div class="first-Cloud">
                    <div class="fc-left">
                        ...
                        <p>On Strategic Management, we are able to equip an organization with the ongoing planning, monitoring, analysis and assessment of all necessities an organization needs to meet its goals and objectives. This helps an organization and its leadership to think about and plan for its future existence. Strategic management process helps organizations take stock of their present situation, chalk out strategies, deploy them and analyze the effectiveness of the implemented management strategies.
                            <h1>We help you with:</h1>
                            <li>Risk management (Product compliant with customer needs and marketing trends).</li>
                            <li>Forecasting (Used to predict the demand of a product).</li>
                            <li>Production plan and control.</li>
                            <li>Supply chain management (Sourcing, Producing, and Shipping).</li>
                    ...
                    <div class="fc-right">
                        <img src="/img/serviceimg/cloud.webp" alt="" height="500" width="100%">
                    </div>
                </div>
