...
<!--home wehere it happens section-->   
 <section class="p-14">
  ...
  @foreach($servicea_1s as $servicea_1)
            <section class="introd">
                <p>{{$servicea_1->tittle}}</p>
            </section>
            <section class="service-head-body">
                <div class="srv-heading">
                    <h2>{{$servicea_1->heading}}</h2>
                    <p>{{$servicea_1->sub_head}}</p>
                </div>
  @endforeach
                <section class="sv-body">
                @foreach($servicea_2s as $servicea_2)
                    <div class="serv-icon si1">
                        <a href="{{$servicea_2->link}}" class="isize"><i class="{{$servicea_2->icon}}"></i></a>
                        <p class="serv-icon-name">{{$servicea_2->name}}</p>
                    </div>
                @endforeach  
