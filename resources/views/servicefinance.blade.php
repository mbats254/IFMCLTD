...
<!--home wehere it happens section-->   
 <section class="p-14">
  ...
  @foreach($servicef_1s as $servicef_1)
            <section class="intro-Audit">
                <p>{{$servicef_1->tittle}}<span>{{$servicef_1->tittle_2}}</span></p>
                <a href="{{$servicef_1->back_link}}" class="bckbtn1" style="text-decoration: none;"><span class="dr2"><i class="fas fa-door-open"></i></span><span
                        class="dr1"><i class="fas fa-door-closed"></i></span> {{$servicef_1->back_text}}</a>
            </section>
            <section class="Audit-detail-body">
                <div class="first-Audit">
                    <div class="fa-left">
                        <h2>{{$servicef_1->heading}}</h2>
                        <p>{{$servicef_1->phrase}}
                        <h1>{{$servicef_1->small_head}}</h1>
                        @foreach($servicef_2s as $servicef_2)
                        <li>{{$servicef_2->phrase}}</li>
                        @endforeach
                        </p>
                    </div>
                    <div class="fa-right">
                        <img src="{{$servicef_1->img}}" alt="" height="500" width="100%">
                    </div>
                </div>
