 ...
 <section class="p-14">
    ...
    @foreach($abouta_1s as $abouta_1)
            ...
            <section class="company-history">
                <div class="note">
                    <div class="hapatu">
                        <h3>{{$abouta_1->heading}}</h3>
                        <div class="l78"></div>
                        <p>
                        {{$abouta_1->phrase}}
                        </p>
                    </div>
                    <div class="abt-img"><img src="{{$abouta_1->img}}" alt="" height="400"></div>
                </div>
            </section>
    @endforeach
            <section class="team-qualify">
            @foreach($abouta_1s as $abouta_1)
                <h1 class="gang_head">{{$abouta_1->team_head}}</h1>
                <p class="gang_sub">{{$abouta_1->team_sub_head}}</p>
            @endforeach
            @foreach($abouta_2s as $abouta_2)
                <div class="ceo inboxx reveal">
                    <div class="ceo_img"><img src="{{$abouta_2->img}}" alt=""></div>
                    <div class="ceo_details">
                        <h1>{{$abouta_2->heading}}</h1>
                        <h2>{{$abouta_2->tittle}}</h2>
                        <p>
                        {{$abouta_2->phrase}}
                        </p>
                    </div>
